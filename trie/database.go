...
type Database struct {
	diskdb db.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb db.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb db.KeyValueStore, cache int) *Database {
