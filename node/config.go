...
import (
	...
	"github.com/chain/go-gech/accounts/external"
	"github.com/chain/go-gech/accounts/keystore"
	"github.com/chain/go-gech/accounts/scwallet"
	"github.com/chain/go-gech/accounts/usbwallet"
...
func (c *Config) ResolvePath(path string) string {
	...
	if warn, isOld := isOldGethResource[path]; isOld {
		...
		if oldpath != "" && common.FileExist(oldpath) {
			if warn {
				c.warnOnce(&c.oldGethResourceWarning, "Using deprecated resource file %s, please move this file to the 'gech' subdirectory of datadir.", oldpath)
			}
			return oldpath
		}
	}
