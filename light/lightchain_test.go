...
func makeHeaderChain(parent *types.Header, n int, db db.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (db.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() db.Database {
	return odr.db
}
