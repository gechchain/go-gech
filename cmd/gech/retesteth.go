...
import (
	...
	"github.com/chain/go-gech/cmd/utils"
	...
	"github.com/chain/go-gech/consensus/misc"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches gech in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches gech in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
var emptyListHash common.Hash = common.HexToHash(glob.Hash + "1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347")
...
func retesteth(ctx *cli.Context) error {
	...
	srv := rpc.NewServer()
	err := node.RegisterApisFromWhitelist(rpcAPI, []string{"test", glob.AddrPrefix, "debug", "web3"}, srv, false)
	if err != nil {
