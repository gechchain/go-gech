...
import (
	...
	"github.com/chain/go-gech/client"
...
var (
	...
	statsFlag   = flag.String("gechstats", "", "Ethstats network monitoring auth string")
...
func newFaucet(genesis *core.Genesis, port int, enodes []*discv5.Node, network uint64, stats string, ks *keystore.KeyStore, index []byte) (*faucet, error) {
	...
	// Assemble the gechstats monitoring and reporting service'
	if stats != "" {
		if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
			var serv *les.LightEthereum
			ctx.Service(&serv)
			return gechstats.New(stats, nil, serv)
		}); err != nil {
			return nil, err
		}
	}
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/chain/go-gech/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
