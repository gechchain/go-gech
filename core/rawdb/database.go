...
import (
	...
	"github.com/chain/go-gech/db/leveldb"
	"github.com/chain/go-gech/db/memorydb"
...
// storage.
func NewDatabaseWithFreezer(db db.KeyValueStore, freezer string, namespace string) (db.Database, error) {
...
func NewMemoryDatabaseWithCap(size int) db.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (db.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (db.Database, error) {
...
func InspectDatabase(db db.Database) error {
