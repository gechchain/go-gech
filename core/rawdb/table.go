...
func NewTable(db db.Database, prefix string) db.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) db.Iterator {
...
func (t *table) NewBatch() db.Batch {
...
func (b *tableBatch) Replay(w db.KeyValueWriter) error {
