...
func wipeSnapshot(db db.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db db.KeyValueStore) error {
...
func wipeKeyRange(db db.KeyValueStore, kind string, prefix []byte, keylen int) error {
