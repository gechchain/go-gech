...
type Tree struct {
	diskdb db.KeyValueStore         // Persistent database to store the snapshot
...
// background thread.
func New(diskdb db.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
