...
// account array.
func checkStateAccounts(t *testing.T, db db.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db db.Database, root common.Hash) error {
...
func checkStateConsistency(db db.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(db.Database), srcRoot)
