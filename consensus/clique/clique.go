...
var (
	...
	nonceAuthVote = hexutil.MustDecode(glob.Hash + "ffffffffffffffff") // Magic nonce number to vote on adding a new signer
	nonceDropVote = hexutil.MustDecode(glob.Hash + "0000000000000000") // Magic nonce number to vote on removing a signer.
