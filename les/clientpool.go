...
func newClientPool(db db.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db db.Database, clock mclock.Clock) *nodeDB {
