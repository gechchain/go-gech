...
import (
	...
	"github.com/chain/go-gech/accounts/abi/bind"
	"github.com/chain/go-gech/accounts/abi/bind/backends"
	"github.com/chain/go-gech/common"
	"github.com/chain/go-gech/common/mclock"
	"github.com/chain/go-gech/consensus/ethash"
	"github.com/chain/go-gech/contracts/checkpointoracle/contract"
	...
	"github.com/chain/go-gech/event"
	"github.com/chain/go-gech/les/checkpointoracle"
	"github.com/chain/go-gech/les/flowcontrol"
...
func testIndexers(db db.Database, odr light.OdrBackend, config *light.IndexerConfig) []*core.ChainIndexer {
...
func newTestClientHandler(backend *backends.SimulatedBackend, odr *LesOdr, indexers []*core.ChainIndexer, db db.Database, peers *serverPeerSet, ulcServers []string, ulcFraction int) *clientHandler {
	var (
...
func newTestServerHandler(blocks int, indexers []*core.ChainIndexer, db db.Database, peers *clientPeerSet, clock mclock.Clock) (*serverHandler, *backends.SimulatedBackend) {
	var (
		gspec = core.Genesis{
			Config:   params.AllEthashProtocolChanges,
			Alloc:    core.GenesisAlloc{bankAddr: {Balance: bankFunds}},
